...
router.get("/requests", auth(Role.ADMIN, Role.LANDLORD), landlordController.getRequests);

router.patch("/requests/:id", auth(Role.LANDLORD), landlordController.manageRequest)
